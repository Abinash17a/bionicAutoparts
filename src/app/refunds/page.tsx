    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-800">
        ...
        <section>
          ...
          <p className="text-xl mb-2">
            It is extremely important that you inspect your shipment thoroughly before accepting and signing for the merchandise. Even though the box and packaging may be intact, it is possible the product could have arrived damaged. If a part does arrive damaged, please accept the delivery and contact Customer Service immediately at <a href="tel:16175163140" className="text-blue-600 underline">(617) 516-3140</a>. Proof of damage may be provided by photos.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-xl mb-2">
            <strong>Freight Shipments:</strong> Before accepting delivery, check for both internal and external damage. Remove the product from its packaging and inspect for damage. If you notice damage, please call our Customer Service immediately at <a href="tel:16175163140" className="text-blue-600 underline">(617) 516-3140</a> after accepting the delivery to obtain a return authorization number.
          </p>
          <p className="text-xl mb-2">
        ...
        <section>
          ...
          <p className="text-xl mb-2">
            USA Used Auto Parts will ship the replacement part as soon as freight charges have been paid for the returned part and the part is on its way back to us.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-xl mb-2">
            If you have refused delivery of your shipment, please contact Customer Service immediately at <a href="tel:16175163140" className="text-blue-600 underline">(617) 516-3140</a>. Shipped items that are either refused by the customer or are unable to be delivered due to continual failed delivery attempts will be returned to USA Used Auto Parts, and you will be credited the amount of the sale, not including shipping and handling. Please allow up to 14 business days for a credit to be issued. It is your responsibility to make immediate and adequate arrangements with the shipping company to accept a shipment in the event of a failed delivery.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-2">USA Used Auto Parts Discretion</h2>
          <p className="text-xl mb-2">
            USA Used Auto Parts reserves the right to deny any exchange or return request. Please do not install damaged or incorrectly shipped items, as doing so will void our return policy. Any parts that have been modified, installed, or damaged in any way by the customer may result in denial of a refund and/or exchange request.
          </p>
          <p className="text-xl mb-2">
        ...
        <section>
          ...
          <p className="text-xl mb-2">
            All refunds will be processed once merchandise has been returned to USA Used Auto Parts. Please allow 5-7 business days for the refund to be posted to your account.
          </p>
        </section>
      </div>
    </div>
