export default function AboutUs() {
  return (
    <section className="container mx-auto px-6 py-8">
      <h1 className="text-4xl font-bold text-center mb-4 text-blue-400">About Us</h1>
      <p className="mt-2 text-center text-lg text-gray-700">We are the best car parts provider in the industry!</p>

      <div className="flex flex-col md:flex-row mt-8">
        {/* Left Side: About the Company */}
        <div className="w-full md:w-1/2 mb-8 md:mb-0">
          <h2 className="text-3xl font-bold text-gray-800">About Our Company</h2>
        ...
        <div className="w-full md:w-1/2 md:pl-8">
          <img
            src="/aboutusmain.jpg"
            alt="About Us"
            className="w-full h-auto rounded-lg shadow-lg border-2 border-blue-600"
          />
        </div>
      </div>
      ...
      <div className="mt-12 text-center bg-blue-500 text-white p-6 rounded-lg shadow-lg">
