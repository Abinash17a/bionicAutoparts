...
const initialData = {
  ...
  models: {
    ...
    Chevy: [
      ...
      'Chevy Truck-Luv Mini Pup', 'Chevy S10, S15, Sonoma', 'Chevy Truck-Silverado 1500 (1999 Up)', 'Chevy Truck-Silverado 2500 (1999 Up)',
    ...
    Chrysler: [
      'Chrysler 200', 'Chrysler 300', 'Chrysler 300M',
      ...
      'Chrysler Sebring', 'Chrysler TC', 'Chrysler Town and Country', 'Chrysler Voyager', 'Chrysler Other',
    ],
    Citroen: [
      'Citroen',
    ],
    ...
    Daihatsu: [
      'Daihatsu Charade', 'Daihatsu Hijet', 'Daihatsu Rocky',
    ],
    Delorean: [
      'Delorean',
    ],
    ...
    Infiniti: [
      'Infiniti EX35', 'Infiniti EX37', 'Infiniti FX', 'Infiniti G20', 'Infiniti G25',
      'Infiniti G35', 'Infiniti G37', 'Infiniti I30', 'Infiniti I35', 'Infiniti J30',
      'Infiniti JX35', 'Infiniti M30', 'Infiniti M35', 'Infiniti M37', 'Infiniti M45',
      'Infiniti M56', 'Infiniti Q40', 'Infiniti Q45', 'Infiniti Q50', 'Infiniti Q60',
      'Infiniti Q70', 'Infiniti QX4', 'Infiniti QX30', 'Infiniti QX50', 'Infiniti QX55',
      'Infiniti QX56', 'Infiniti QX60', 'Infiniti QX70', 'Infiniti QX80',
    ],
    Isuzu: [
      'Isuzu Amigo', 'Isuzu Ascender', 'Isuzu Axiom', 'Isuzu Gemini', 'Isuzu IMark',
      'Isuzu Impulse', 'Isuzu Oasis', 'Isuzu Optima', 'Isuzu Reach', 'Isuzu Rodeo',
      'Isuzu Stylus', 'Isuzu Trooper', 'Isuzu Truck (Big)', 'Isuzu Truck-(Mini Pickup)',
      'Isuzu Truck-(Mini Pickup) Hombre', 'Isuzu Truck i280 (Pickup)',
      'Isuzu Truck i290 (Pickup)', 'Isuzu Truck i350 (Pickup)', 'Isuzu Truck i370 (Pickup)',
      'Isuzu Vehicross',
    ],
    Jaguar: [
    ...
    Lotus: [
      'Lotus', 'Lucid Air', 'Lucid Gravity',
    ],
    MG: [
      'MG MGB', 'MG Midget', 'MG Other',
    ],
    Maserati: [
      'Maserati', 'Maserati BiTurbo', 'Maserati Ghibli', 'Maserati GranTurismo',
      'Maserati Grecale', 'Maserati Grecale GT', 'Maserati Levante', 'Maserati Quattroporte',
    ],
    Maybach: [
      'Maybach',
    ],
    ...
    McLaren: [
      'McLaren 570GT', 'McLaren 570S', 'McLaren 600LT', 'McLaren 620R', 'McLaren 650S',
      'McLaren 675LT', 'McLaren 720S', 'McLaren 765LT', 'McLaren Artura', 'McLaren GT',
      'McLaren MP4 12C', 'McLaren P1', 'McLaren Senna',
    ],
    MercedesBenz: [
    ...
    Mercury: [
      'Mercury Bobcat', 'Mercury Capri', 'Mercury Comet', 'Mercury Cougar',
      'Mercury Grand Marquis (1979 Down)', 'Mercury Grand Marquis (1980 Up)', 'Mercury LN7',
      'Mercury Lynx (except LN7)', 'Mercury Marauder', 'Mercury Mariner',
      'Mercury Marquis (not Grand)', 'Mercury Merkur (includes XR4TI and Scorpio)',
      'Mercury Milan', 'Mercury Monarch', 'Mercury Montego', 'Mercury Monterey',
      'Mercury Mountaineer', 'Mercury Mystique', 'Mercury Sable', 'Mercury Topaz', 'Mercury Tracer',
      'Mercury Villager', 'Mercury Zephyr', 'Mercury Other',
    ],
    Mini: [
    ...
    Oldsmobile: [
      'Oldsmobile 88 (1979 Down)', 'Oldsmobile 88 (1980 Up)', 'Oldsmobile 98 (1979 Down)', 'Oldsmobile 98 (1980 Up)',
      'Oldsmobile Achieva', 'Oldsmobile Alero', 'Oldsmobile Aurora', 'Oldsmobile Bravada', 'Oldsmobile Calais (1984 Down)',
      'Oldsmobile Calais (1985 Up)', 'Oldsmobile Ciera', 'Oldsmobile Custom Cruiser (1979 Down)', 'Oldsmobile Custom Cruiser (1980 Up)',
      'Oldsmobile Cutlass (1972 Down)', 'Oldsmobile Cutlass (1973 Up)', 'Oldsmobile F85', 'Oldsmobile Firenza', 'Oldsmobile Intrigue', 'Oldsmobile Omega',
      'Oldsmobile Silhouette', 'Oldsmobile Starfire', 'Oldsmobile Supreme-Calais (1988 Up)', 'Oldsmobile Supreme-Cutlass (1988 Up)', 'Oldsmobile Supreme (1972 Down)',
      'Oldsmobile Supreme (1973-1987)', 'Oldsmobile Toronado', 'Oldsmobile Other', 'Opel', 'Oshkosh', 'Pace Arrow', 'Packard', 'Pantera', 'Peterbilt', 'Peugeot 304',
      'Peugeot 403', 'Peugeot 404', 'Peugeot 405', 'Peugeot 504', 'Peugeot 505', 'Peugeot 604',
    ],
    Plymouth: [
    ...
    Porsche: [
      ...
      'Porsche 928', 'Porsche 944', 'Porsche 968', 'Porsche Boxster', 'Porsche Carrera-GT',
      'Porsche Cayenne', 'Porsche Cayman S', 'Porsche Macan', 'Porsche Panamera', 'Porsche Taycan',
    ],
    Ram: [
    ...
    Renault: [
      'Renault Alliance', 'Renault Clio', 'Renault Dauphine', 'Renault Encore', 'Renault Fuego',
      'Renault Gordini', 'Renault Lecar', 'Renault Medallion', 'Renault Megane', 'Renault R8',
      'Renault R10', 'Renault R12', 'Renault R15', 'Renault R16', 'Renault R17', 'Renault R30',
      'Renault Other', 'REO', 'Rivian R1S', 'Rivian R1T', 'Renault 18I',
    ],
    RollsRoyce: [
      'RollsRoyce',
    ],
    Rover: [
      'Rover 3 Litre', 'Rover 100', 'Rover 2000', 'Rover 3500', 'Rover 3500S',
    ],
    Saab: [
      'Saab 9-3 (1999 Up)', 'Saab 9-5 (1999 Up)', 'Saab 92x', 'Saab 93 (1960 Down)',
      'Saab 94x', 'Saab 95 (1972 Down)', 'Saab 96', 'Saab 97x', 'Saab 99', 'Saab 900 (incl Turbo)',
      'Saab 9000 (incl Turbo)', 'Saab Monte Carlo', 'Saab Sonett', 'Saab Sonett III',
    ],
    Saturn: [
      'Saturn Astra', 'Saturn Aura', 'Saturn EV1', 'Saturn Ion', 'Saturn L Series',
      'Saturn S Series', 'Saturn Outlook', 'Saturn Relay', 'Saturn Sky', 'Saturn Vue',
      'Scion FRS', 'Scion iA', 'Scion iM', 'Scion iQ', 'Scion tC', 'Scion xA', 'Scion xB',
      'Scion xD', 'Seat Cordova', 'Seat Ibiza', 'Seat Leon', 'Seat Toledo', 'Simca',
      'Smart Fortwo', 'SterlingRover', 'Studebaker',
    ],
    Subaru: [
    ...
    Triumph: [
      'Triumph GT6', 'Triumph Spitfire', 'Triumph Stag', 'Triumph TR2', 'Triumph TR3',
      'Triumph TR4', 'Triumph TR4A', 'Triumph TR6', 'Triumph TR7', 'Triumph TR8', 'Triumph TR250',
